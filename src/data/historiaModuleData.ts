  ...
  grecia: {
    ...
    writtenPrompts: [
      ...
      },
      {
        ...
        minimumWords: 20,
        sampleModelAnswer: "La Acrópolis era la parte más alta y fortificada de la ciudad donde se construían los templos sagrados como el Partenón. En cambio, el Ágora era la plaza abierta en la zona baja donde se instalaba el mercado y los ciudadanos se reun<dyad-write path="src/data/historiaModuleData.ts" description="Complete and robust dataset for Historia Universal including Antigua Grecia and Antigua Roma with lessons, multiple choice, true/false, and written prompts">
export interface MultipleChoiceItem {
  id: number;
  question: string;
  options: string[];
